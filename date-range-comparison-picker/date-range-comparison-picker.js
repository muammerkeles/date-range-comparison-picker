/* 
 * DatePicker 2.0.0
 * improving to works like Google Analytics Specifications. by Muammer Keleş.
 *
        ...
        var ids = {},
            ...
            tpl = {
                ...
                filters: [
                    ...
                    '<label class="col-xs-4 control-label"><%=dateRange%></label > ',
                    '<div class="col-xs-8">',
                    ...
                    '<div class="form-group" data-id="firstinputgroup">',
                    '<div class="col-xs-6">',
                    ...
                    '<div class="col-xs-6">',
                    '<div class="checkbox">',
                    '<label data-click="free">',
                    '<input type="checkbox" data-id="chkcompare"/><%=comparewith%></label>',
                    '</div>',
                    '</div>',
                    '<div class="col-xs-6">',
                    ...
                    '<div class="form-group" data-id="secondinputgroup" style="display:none">',
                    '<div class="col-xs-6">',
                    ...
                    '<div class="form-group">',
                    '<div class="col-xs-12">',
                    '<button type="button" class="btn btn-primary pull-left" data-id="btnapply"><%=apply%></button><button type="button" data-id="btncancel" class="btn btn-link pull-right"><%=cancel%></button>',
                    '</div>',
                    '</div>',
                    '</form>',
                    '</div>',
    ...
    this.turkishlocale = function () {
        return {
            ...
            filterWords: {
                ...
                //last2Weeks: "\u00d6nceki 2 hafta",
                lastMonth: "Ge\u00e7en Ay",
                last7Days: "Son 7 Gun",
                last30Days: "Son 30 Gun",
                //last4Months: "\u00d6nceki 4 Ay",
                //last5Months: "\u00d6nceki 5 Ay",
                //last6Months: "\u00d6nceki 6 Ay",
                //last7Months: "\u00d6nceki 7 Ay",
                //lastYear: "Ge\u00e7en Sene",
                compareWith: "\u015eununla Kar\u015f\u0131la\u015ft\u0131r",
                previousSeason: "\u00d6nceki donem",
                previousYear: "Ge\u00e7en Sene",
                apply: "Uygula",
                cancel: "Vazgec"
            }
        };
